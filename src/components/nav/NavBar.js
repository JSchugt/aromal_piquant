        ...
        <div id="headerTop">
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" id="svg" version="1.1" width="90" height="90" viewBox="0 0 90 90">
              <g id="svgg">
                <polygon points="0,45 30.6,40.5 45,45 9,9 40.5,30.6 45,45 45,0 49.5,30.6 45,45  81,9  59.4,40.5 45,45 90,45 59.4,49.5 45,45  81,81 49.5,59.4  45,45 45,90 40.5,59.4 45,45  9,81 30.6,49.5 45,45 "   fill="#0487d9"  />
